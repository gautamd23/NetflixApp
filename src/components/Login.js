  ...
  return (
    <div>
      ...
      <div className="absolute ">
        <img
          className="object-cover w-screen h-svh"
      ...
      >
        <h1 className="font-bold text-3xl text-white my-3 mx-2">
        ...
        <p className="cursor-pointer text-xs py-3 mx-2" onClick={handleToggleSignIn}>
          {showSignIn
