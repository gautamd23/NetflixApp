      ...
      <div className="w-[90%] flex gap-3 pt-24 px-12 justify-between ">
        <div className="flex flex-col mt-6 w-[600px] px-3 ">
          ...
          <div className="flex gap-3 mt-6">
            <button className="py-2 px-10 font-bold text-xl bg-white text-black rounded-lg hover:bg-gray-400">
              Play
            </button>
            {/* <button className="py-2 px-6 font-bold text-xl bg-gray-100 text-white rounded-lg bg-opacity-20 hover:bg-opacity-15">
              More Info
            </button> */}
          </div>
        </div>
